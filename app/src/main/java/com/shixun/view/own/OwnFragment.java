...
import com.shixun.R;
import com.shixun.adapter.Rec_MeAdapter;
...
public class OwnFragment extends Fragment {
    ...
    private void initView(View view) {
        ...
        tvMeName.setText("安可爱");
        Glide.with(getActivity()).load(R.mipmap.e).apply(new RequestOptions().circleCrop()).into(ivMeTouxiang);
    }
}
